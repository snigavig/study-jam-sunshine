...
import com.goodcodeforfun.sunshine.data.WeatherContract.WeatherEntry;
import com.goodcodeforfun.sunshine.data.WeatherContract.LocationEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.pref_key_unit_system),
