 ...
 */
package com.goodcodeforfun.sunshine.data;
...
import com.goodcodeforfun.sunshine.data.WeatherDbHelper;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Validation failed", c, northPoleValues);
    ...
    public void testWeatherTable() {
        ...
        TestUtilities.validateCurrentRecord("Validation failed", c, weatherContentValues);
        // Finally, close the cursor and database
        c.close();
        db.close();
    }
